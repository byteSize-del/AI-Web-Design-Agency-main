    ...
    <section className="py-24 px-6 md:px-16 lg:px-24 bg-black max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {testimonials.map((testimonial, index) => (
          <div key={index} className="liquid-glass rounded-2xl p-8 flex flex-col justify-between h-full transition-all duration-500 ease-out hover:-translate-y-2 hover:shadow-[0_0_30px_rgba(255,255,255,0.1)] hover:bg-white/[0.02]">
